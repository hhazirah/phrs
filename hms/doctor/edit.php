...
<html lang="en">
	<head>
		<title>Doctor | Change Appointment</title>
		<meta charset="utf-8" />
					...
					<div class="wrap-content container" id="container">
						...
						<div class="container-fluid container-fullw bg-white">
								...
								<table class="table table-hover" id="sample-table-1">
                                 ...
                                 <label class="control-label col-sm-3">Change The status  </label>
                                                        ...
                                                        if(isset($_POST['submit2']))
                                                        {
                                                        	$status=$_POST["status"];
                                                        	 ...
                                                        	 $recordid = $_REQUEST['recordID'];
                                                        	  ...
                                                        	  $result = ("UPDATE appointment SET status='$status' WHERE bookId = '$recordid' ");
                                                              $add = mysqli_query($con, $result) ;
                                                              if($add){
                                                            ?>
                                                            <script type="text/javascript">
                                                            alert('Update data Successfull');
                                                            document.location.href="viewappointment.php";
                                                            </script>
                                                            <?php
                                                            } else {
                                                                ?>
                                                           <script type="text/javascript">
                                                            alert('Update data Unsuccessfull');
                                                            document.location.href="viewappointment.php";
                                                            </script>
                                                            <?php
                                                            }
