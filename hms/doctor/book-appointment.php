...
$query=mysqli_query($con,"INSERT INTO appointment(bookId,appointmentDate,appointmentTime,notes) values('$bookId','$appointmentDate','$appointmentTime','$notes')");
	if($query)
	{
...
<div class="form-group">
           ...
           // echo $id
                                                        ...
                                                        if(isset($_POST['submit']))
                                                        {
                                                           ...
                                                           $query="INSERT INTO appointment(appointmentDate,appointmentTime,notes,status,id) VALUES('$appointmentDate','$appointmentTime','$notes','$status','$id')";
	                                                      ...
	                                                      if($add){
                                                            ...
                                                            document.location.href="book-appointment.php";
                                                            </script>
