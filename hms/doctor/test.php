                                                ...
                                                <div class="panel-body">
                                                       ...
                                                       <div class="container">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="panel-body">
                                                                <div style="width: 350px; margin: 70 px auto;">
                                                                <center>
                                                                    ...
                                                                    <label class="control-label col-sm-3">Tarikh: </label>
                                                                        <div class="col-sm-9">
                                                                            <input type="date" class="form-control" name="date" required="required"><br/></div>

                                                                    
                                                                    <label class="control-label col-sm-3">LK/LR  </label>
                                                                    <div class="col-sm-9">
                                                                    <select  class="form-control" name=" lk" required="required">
                                                                    <option value="">Select</option>   
                                                                    <?php 
                                                                    $sql=mysqli_query($con,"select * from lk");
                                                                    while($row=mysqli_fetch_array($sql))
                                                                    {
                                                                    ?>
                                                                    <option value="<?php echo htmlentities($row['lk']);?>"><?php echo htmlentities($row['lk']);?></option>
                                                                    <?php } ?>
...
<br><br><br><br>                                                    <label class="control-label col-sm-3">Urinalb: </label>
                                                                        <div class="col-sm-9">
                                                                            <input type="text" class="form-control" name="urinalb" required="required"><br/></div>

                                                                    <label class="control-label col-sm-3">Urinsugar: </label>
                                                                        <div class="col-sm-9">
                                                                            <input type="text" class="form-control" name="urinsugar" required="required"><br/></div>

                                                                    <label class="control-label col-sm-3">hb: </label>
                                                                        <div class="col-sm-9">
                                                                            <input type="text" class="form-control" name="hb" required="required"><br/></div>

                                                                    <label class="control-label col-sm-3">beratbdn: </label>
                                                                        <div class="col-sm-9">
                                                                            <input type="text" class="form-control" name="beratbdn" required="required"><br/></div>

                                                                    <label class="control-label col-sm-3">Tekdarah: </label>
                                                                        <div class="col-sm-9">
                                                                            <input type="text" class="form-control" name="tekdarah" required="required"><br/></div>

                                                            

                                                                    <label class="control-label col-sm-3">Nadi: </label>
                                                                        <div class="col-sm-9">
                                                                            <input type="text" class="form-control" name="nadi"required="required"><br/></div>

                                                                    <label class="control-label col-sm-3">Edema: </label>
                                                                        <div class="col-sm-9">
                                                                            <input type="text" class="form-control" name="edema" required="required"><br/></div>

                                                                     <label class="control-label col-sm-3">Minggu: </label>
                                                                        <div class="col-sm-9">
                                                                            <input type="text" class="form-control" name="minggu" required="required"><br/></div>

                                                                    <label class="control-label col-sm-3">Tinggi rahim: </label>
                                                                        <div class="col-sm-9">
                                                                            <input type="text" class="form-control" name="tinggirahim" required="required"><br/></div>

                                                                    <label class="control-label col-sm-3">Presentasi: </label>
                                                                        <div class="col-sm-9">
                                                                            <input type="text" class="form-control" name="presentasi"required="required"><br/></div>

                                                                    <label class="control-label col-sm-3">Jantung: </label>
                                                                        <div class="col-sm-9">
                                                                            <input type="text" class="form-control" name="jantung" required="required"><br/></div>

                                                                    <label class="control-label col-sm-3">Gerak: </label>
                                                                        <div class="col-sm-9">
                                                                            <input type="text" class="form-control" name="gerak" required="required"><br/></div>

                                                                    <label class="control-label col-sm-3">Masalah: </label>
                                                                        <div class="col-sm-9">
                                                                            <input type="text" class="form-control" name="masalah" required="required"><br/></div>
