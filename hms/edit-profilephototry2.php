...
$sql=mysqli_query($con,"Update users set fullName='$fname',photo='$photo',ic='$ic',race='$race',address='$address',hpnumber='$hpnumber',hnumber='$hnumber',pregnancy='$pregnancy',children='$children',job='$job',jobadd='$jobadd',jobtel='$jobtel' where id='".$_SESSION['id']."'");
