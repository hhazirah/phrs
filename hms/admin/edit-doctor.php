...
$sql=mysqli_query($con,"Update doctors set doctorName='$doctorName',doctorid='$doctorid',address='$address',contactno='$contactno',docEmail='$docEmail' where id='$did'");
if($sql)
{
...
<?php if($msg) { echo htmlentities($msg);}?> </h5>
									...
									<?php $sql=mysqli_query($con,"select * from doctor where id='$did'");
