										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h1><div class="panel-title">MY PROFILE</div></h1>
												</div>
...
<label for="photo">
																  <?php echo htmlentities($data['photo']);?>
															</label> </div>-->
...
<label for="fname">
																Full Name : <?php echo htmlentities($data['fullName']);?>
															</label> </div>


<div class="form-group">
															<label for="ic">
																 NRIC : <?php echo htmlentities($data['ic']);?>
															</label>
														</div>
